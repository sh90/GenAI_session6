...
```bash
git clone https://github.com/sh90/GenAI_session6.git
```

Alternatively, you can [download the ZIP file](https://github.com/sh90/GenAI_session6/archive/refs/heads/master.zip) and extract it.
